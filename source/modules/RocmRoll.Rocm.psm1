...
function Resolve-RocmInstallPlan {
    ...
    $commonArgs = New-PipBaseArgs -Config $cfg
...
function Invoke-InstallRocm {
    ...
    if ($installPlan.torchDeps.Count -gt 0) {
        ...
        $torchDepsArgs = (New-PipBaseArgs -Config $cfg) + $installPlan.torchDeps
...
function Invoke-ValidateRocm {
    ...
    $pyScript = Get-Content (Join-Path $PSScriptRoot '..\scripts\validate-rocm.py') -Raw -Encoding UTF8
